...
router.delete("/user/deleteUser/:id", auth2.authReq, auth, userController.deleteUser);
...
router.post("/user/refreshToken",auth2.authReq, userController.createRefreshToken);
router.post("/user/restPass",auth2.authReq, userController.restPass);
router.put("/user/restPass/:id",auth2.authReq, auth, userController.restPassById);
